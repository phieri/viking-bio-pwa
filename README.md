...
A monorepo for the [Viking Bio 20](https://varmebaronen.se/produkter/single/p-15/viking-bio-pelletsbrannare) pellet burner integration system. It consists of three active parts:
...
The older **[push-pwa/](push-pwa/)** directory is a legacy/archived implementation and is not part of the currently active runtime architecture.
