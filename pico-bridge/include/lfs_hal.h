...
// LittleFS filesystem size: 3/8 of total flash at end of flash
// Pico W  (2 MB flash) → 768 KB (192 × 4 KB blocks)
// Pico 2 W (4 MB flash) → 1536 KB (384 × 4 KB blocks)
#define LFS_FLASH_SIZE    (PICO_FLASH_SIZE_BYTES * 3 / 8)
