...
├── docs/                            # Astro marketing-site source; dist/ is generated by CI and not committed
...
- The marketing landing page now uses Astro SSG in `docs/`; `docs/dist/` is generated during CI
  and published as a GitHub Pages artifact rather than checked into git. Do not commit built HTML
  or custom post-build HTML snapshots under `docs/`.
