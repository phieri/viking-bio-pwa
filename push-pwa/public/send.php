...
$rawPriority = is_string($data['notificationPriority'] ?? null) ? strtolower($data['notificationPriority']) : (is_string($data['priority'] ?? null) ? strtolower($data['priority']) : 'normal');
